...
import { getOpenIncidentCountsFn, listOpenIncidentsFn } from "../lib/incidents";
	...
	return (
		...
		>
			<Sidebar
				...
				openIncidentCount={openIncidentTotal}
			/>
			<main
				style={{
					flex: 1,
					...
					>
						{kpis.map((k) => (
							...
							>
								...
								{k.sub && (
									<span style={{ fontSize: 11.5, color: k.subColor }}>
										{k.sub}
									</span>
								)}
							</div>
							...
							>
								...
								{openIncidents.map((inc) => (
									...
									>
										...
										<span
											style={{ fontSize: 11.5, color: "var(--sf-fg-muted)" }}
										>
											{inc.equipment_name}
										</span>
									</div>
		...
		<Link
			...
			style={{
				...
				...(equipment.status === "broken"
					? {
							color: "var(--sf-danger)",
							borderColor: "var(--sf-danger-border)",
						}
					: equipment.status === "available"
						? {
								color: "var(--sf-primary-soft)",
								borderColor: "var(--sf-primary-border)",
							}
						: {}),
			}}
		>
			...
			>
				...
				<Link to="/equipment/new" style={{ textDecoration: "none" }}>
					<div style={tileBtnStyle}>
						<span
							style={{ ...tileIconBase, background: "var(--sf-primary-tint)" }}
						>
				...
				<div style={tileBtnStyle}>
					<span
						style={{ ...tileIconBase, background: "var(--sf-danger-tint)" }}
					>
