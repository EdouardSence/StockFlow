...
const sans =
	"'Liberation Sans', 'DejaVu Sans', 'Helvetica Neue', Arial, system-ui, sans-serif";
const mono = "'DejaVu Sans Mono', 'Liberation Mono', monospace";

const html = `
<style>
  @page {
    size: A4; margin: 22mm 20mm 18mm;
    @bottom-center { content: counter(page) " / " counter(pages); font-size: 8pt; color: #888; }
  }
  @page :first { @bottom-center { content: ""; } }
  * { box-sizing: border-box; }
  body { font-family: ${sans}; font-size: 11.5pt; line-height: 1.6; color: #1a1a1a; margin: 0; }
  ...
  table { border-collapse: collapse; width: 100%; font-size: 9.5pt; margin: 4mm 0 6mm; table-layout: auto; }
